            ...
            <li>
              <section className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                >
                  ...
                  <NavLink to="/products" className={({ isActive }) => (isActive ? "  text-blue-600 font-bold w-full h-full" : "h-full w-full")}>
                <span className="flex-1 ml-3 whitespace-nowrap">
                    Products
                </span>
                  </NavLink>
            ...
            <li>
              <section className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                >
                  ...
                  <NavLink to="/logout" className={({ isActive }) => (isActive ? "  text-blue-600  w-full font-bold h-full" : "h-full w-full")}>
                <span className="flex-1 ml-3 whitespace-nowrap">
                    Logout
                </span>
                  </NavLink>
